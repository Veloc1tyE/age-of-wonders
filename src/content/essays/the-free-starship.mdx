...
<Callout type="info">
**Energy autonomy.** Power that doesn't thin with distance. Not solar panels that weaken as the Sun shrinks to a star, but fusion — dense enough to carry you past the Sun.<sup><a href="#ref-17">[17]</a></sup> Energy is the master resource — [the one that unlocks everything else](/essays/create-an-age-of-wonders).
