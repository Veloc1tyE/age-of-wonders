...
The foundation is invisible while it works, the way grammar is invisible to a fluent speaker. You notice it only when it fails: a financial crisis, a pandemic, a region the grid never reached. That is when "the market will sort it out" reveals itself as faith in a mechanism never designed to sort *that* out.
...
Love needs a sharp definition to be tractable.
