...
Moreso, if it weren't for the atmosphere's forcing function—Max Q—we could send all manner of things into space with terrestrial cannons.
...
One brief peak in the curve. Everything else sits below three g. Seats articulate throughout, keeping passengers in the transverse +G<sub>x</sub> orientation — force spread across the body, not head-to-toe. Consistent with NASA human-systems guidance.<sup><a href="#ref-38">[38]</a></sup> Gentler than a rocket's Max Q. (Appendix E: phase-by-phase seat mechanics.)
...
<span id="ref-18">[18]</span> NASA (2024). "Environmental Impacts of Launch Vehicle Emissions." NASA Technical Memorandum. Review of particulate emissions from launch and reentry, comparison to meteoritic background flux.
...
<span id="ref-30">[30]</span> NASA Sun-Climate Research Center. "Total Solar Irradiance." https://sunclimate.gsfc.nasa.gov/sun-and-climate. TSI ≈ 1361.6 W/m²; global average input ~340 W/m².
