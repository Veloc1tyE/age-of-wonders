...
**The tunnel.** An evacuated electromagnetic track, roughly 30 km long, bored through mountain bedrock. Cargo and human flights share the same bore; only the acceleration program differs — a gentle 3 g climb for people, 20+ g for cargo. The vehicle rides in a cradle that spreads the load around the hull, so the mountain takes the bending moment and the hull feels only a uniform squeeze (Appendix E). One tunnel. Two programs.

**The terminal.** A near-vertical pylon rising 10–15 km above a high-altitude summit: a tension-stabilised carbon-nanotube mast held rigid by guy cables anchored in bedrock.<sup><a href="#ref-4">[4]</a></sup> It carries no coils. The payload reaches exit velocity below and coasts through. The mountain carries compression. The cables carry tension.

**The exit.** Cargo leaves at roughly 3 km/s, human flights at ~700 m/s, aimed nearly vertically from about 20 km — high enough to clear the densest air, low enough that the thin remaining air is still a resource. The lifting body banks, harvesting up to ~500 m/s of free horizontal velocity at almost no cost in altitude (Appendix C2). At 700 m/s the exit pressure is gentler than a rocket's Max Q. Same bridge, different software.
</Callout>
...
The propellant savings cascade. For 100 tonnes delivered to low Earth orbit, the launcher-plus-hydrolox path cuts propellant by about 64% against an all-rocket baseline (Appendix D).

Hydrolox is the near-term workhorse. Nuclear thermal propulsion, at roughly 900 s specific impulse,<sup><a href="#ref-6">[6]</a></sup> cuts propellant by 88% against the same baseline. It halves the mass ratio and the lane count, but not the electricity bill: the propellant is still hydrogen, still produced by electrolysis (Appendix M). The centurial upgrade.
...
**The g-force profile.** Eight minutes, tunnel to orbit. Three g in the tunnel, one brief touch of seven in the curve, weightless up the pylon, then a long burn that reaches five g only as the tanks run dry. One peak, under three seconds.
...
The throughput changes the entire conversation. In 2024, all of humanity put roughly 2,171 tonnes into orbit.<sup><a href="#ref-8">[8]</a></sup> One launcher at daily cadence delivers more than ten times that. Faster cadences scale toward 400× the world's annual upmass at a shot an hour (Appendix G).
...
**Phase 3: 2060s–2090s - Earth cargo assist.** The terrestrial launcher begins freight operations. The pylon unlocks the full architecture: lower g-loading and max-q for all cargo classes, and eventually human transit.

**Phase 4: 2090s–2130s - The orbital industrial mantle.** Multiple launcher sites and tens of mega-tonnes of lunar export support habitat construction at scale. Off-world natural growth begins to exceed net migration. 

**Phase 5: 2130s–2180s - The long transition.** New heavy industrial construction defaults to orbit. Terrestrial smelters close. Forests return. Rivers clear.

**Phase 6: Late 22nd century - Earth as garden.** Off-world population approaches Earth's. Most heavy industry operates in cis-lunar space, fed by lunar mass at the cost of electricity. Earth remains home to billions as a protected nature reserve.
