...
It is why population migration lags industrial migration: cargo economics improve faster than passenger economics. The crossover arrives only once ferry costs compress far enough that millions can choose to go, not just thousands assigned to go.
...
Energy, materials, and thermal management all favour space once the logistics exist. Industry migrates not because it is asked to, but because the orbital alternative is cheaper. Earth stops being the default site of production, and begins to recover.
