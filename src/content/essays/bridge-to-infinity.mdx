...
Three elements. A tunnel bored through the mountain — electromagnetic, evacuated, silent — accelerates the vehicle through bedrock to exit speed. A pylon carries the exit from the summit into the stratosphere. At altitude, the lifting body banks: thin air trading for horizontal velocity before the engine has burned a gram of propellant (Appendix C2, E).
...
Any lifting body rated for re-entry handles the exit pulse (Appendix C3). The hardest part is coming home. That problem is already solved.<sup><a href="#ref-19">[19]</a></sup>
...
*100 tonnes to LEO, 20 km exit altitude (Appendix D).*
...
Hydrolox is the near-term workhorse. Nuclear thermal propulsion is the centurial upgrade (Appendix M).<sup><a href="#ref-6">[6]</a></sup> 
