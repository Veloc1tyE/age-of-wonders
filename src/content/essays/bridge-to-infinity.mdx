...
import earthrise from '../../../public/images/earthrise-optimized.jpg';
...
<Figure
  src={earthrise}
  alt="Earthrise photographed from Apollo 8 lunar orbit, December 1968, Earth rising above the grey lunar surface"
  caption="Earthrise, December 24, 1968. Give industry somewhere better to go. It will go."
  wide
/>
