...
Read the two figures as bounding cases, not a multiplied ratio. They point the same direction. Across the broad surface of paid-for capacity, much of the ordered compute is doing little economic work. The rest is optionality — a placeholder, a reservation, a hedge against being last in line for a slot. Appendix D sets out the distinction.
...
The forward predictions remain observable on known timetables. The operator-distress trough crystallising across 2027–2028 as a cluster of operator-distress and secondary-market signals fire together. Secondary-market clearing prices on the pre-order pipeline as it lands — Rubin, Rubin Ultra, Feynman across 2027–2029 (H.8). The labour-market shift to verification work compounding from the 20% early-career signal of 2024–2026 (K.3). The macroeconomic productivity acceleration resolving toward one of the Goldman / Penn Wharton / Acemoglu trajectories (K.4). The convergence-of-capital effect on hyperscaler asset cascading materialising or not, observable in whether mid-market specialist-cloud and infrastructure-developer estates clear through distressed-asset sales in volume at the trough. Each is checkable from public data on its own clock.
