...
The first AI capital cycle is overbuilding the machinery of intelligence before the economy knows how to use it. These chips, currently asleep on pallets, will soon go to work throughout the economy.

## I. The Plug

The limit on AI is electricity, permitting, and time.

The hyperscalers expect to spend more than \$700 billion on AI and cloud infrastructure in 2026 alone.<sup><a href="#ref-3">[3]</a></sup> To fund it, the top five U.S. hyperscalers issued a record \$121 billion in corporate bonds during 2025, more than four times their historical annual average, and Bank of America projects \$175 billion in 2026 issuance.

Amazon's \$54 billion global bond sale in March 2026 was the largest debt transaction in the company's history.<sup><a href="#ref-4">[4]</a></sup> AI-linked venture deployment reached roughly a quarter-trillion dollars in a single quarter, dominated by OpenAI's \$122 billion round, Anthropic's \$30 billion round, and xAI's \$20 billion round.<sup><a href="#ref-5">[5]</a></sup> U.S. private equity poured \$45.7 billion into data centres in 2025, representing 72% of all sector investment.<sup><a href="#ref-6">[6]</a></sup> Every quarter, the bottleneck moves further down the supply chain: Nvidia, TSMC, SK Hynix, Vertiv, GE Vernova, Siemens Energy, transformers, substations, turbines, permits. (See Appendix A for definitions, period coverage, and the source aggregation.)

None of it ships intelligence to a customer.

It ships steel, copper, silicon, and slabs of poured concrete to a power easement that does not exist yet. The bottleneck has migrated. It used to be the model. Then briefly it was the chip. Now it is the substation, the transformer, the gas turbine, the air permit, the water permit, the cooling tower, the grid-interconnect queue.<sup><a href="#ref-7">[7]</a></sup>
...
The market priced AI as if compute and intelligence were the same thing. Compute is silicon in racks in halls connected to substations connected to gas turbines or nuclear cores connected to fuel that has to be physically delivered. The chip is the easy part.

In 2026 geography entered the argument. Henry Hub gas sat near \$2.83/MMBtu while TTF in Europe and JKM in Asia traded above \$17 and \$18/MMBtu respectively.<sup><a href="#ref-8">[8]</a></sup> Run that fuel through a combined-cycle plant at the U.S. EIA's 2024 heat rate<sup><a href="#ref-9">[9]</a></sup> and the fuel-only marginal cost of electricity in LNG-import regions is six to seven times the U.S. baseline. For a continuously loaded 100 MW campus the fuel-only marginal-cost spread alone is roughly \$100 million a year — before transmission, capacity charges, cooling, financing, or carbon. Compute is now a geography.
...
In January 2026, Amazon Web Services raised the price of its H200 Capacity Blocks by 15% — one of the clearest material price increases in current-generation cloud compute after two decades in which headline cloud pricing mostly moved downward.<sup><a href="#ref-10">[10]</a></sup> The energised slot is scarce.

## II. The Order Book Is Not Demand

Walk a small public sample of named projects, enough to make the structural gap visible.
...
*Facility-load figures use disclosed facility design power where available (Colossus, Abilene) and an industry-rough heuristic of approximately 1.3 kW per top-end accelerator for all-in load otherwise.<sup><a href="#ref-13">[13]</a></sup> See Appendix C for the arithmetic and caveats.*

Take the three projects with disclosed status. Together they imply on the order of 2.6 gigawatts of accelerator facility load ordered or planned. The confirmed energised fraction, by mid-2026, is closer to 0.6 gigawatts. Roughly a fifth of the ordered facility load *in this public sample* is plugged in.

That is one half of the gap. The other half is utilisation.

Cast AI, surveying production Kubernetes clusters across AWS, Azure, and Google Cloud, measured an average sustained GPU utilisation of 5%.<sup><a href="#ref-14">[14]</a></sup> That is an enterprise figure, not a frontier one — frontier training clusters run to saturate silicon for weeks at a time. Enterprise fleets provision for bursty demand and idle between requests.

Read the two figures as bounding cases, not a multiplied ratio. Together they point the same direction. Across the broad surface of paid-for capacity, a great deal of ordered compute is currently doing very little economic work. The rest is optionality — a placeholder, a reservation, a hedge against being last in line for a slot. (Appendix D sets out the distinction in full.)
...
What has been priced as a vertical demand curve for compute is a vertical demand curve for *optionality* on compute. That is a meaningful distinction, because options expire. The Blackwell-era chips ordered for 2025 deployment run into Rubin and Rubin Ultra. The chips ordered after that run into Feynman-era roadmap pressure. The grid moves slower than the architecture cadence.

Much of the most aggressive AI-infrastructure pricing assumed that agentic workflows would convert model capability into economic labour substitution on a near-term timetable. The deployment rails did not arrive on time.

Models are powerful and getting more powerful. The verification, observability, permissions, audit, rollback, and trust infrastructure that converts capability into deployable workflows is being built. So is the legal architecture. So is the institutional appetite. The frontier-lab demand curve is real. The economy-wide demand curve is real *eventually*. It is not real in the energisation window of the chip already ordered.
...
Capability arrives before verification, regulation, and integration. It always has — in medicine, in finance, in software itself.<sup><a href="#ref-17">[17]</a></sup> AI in the broader economy faces the same clock.
...
The Q1 2026 financials make the asymmetry impossible to miss.

OpenAI reported a -122% operating margin — Q1 revenue \$5.7 billion against an operating loss of \$6.95 billion, tracking toward a \$36.6 billion loss for the year. ChatGPT weekly active users stalled at 905 million, below the 1 billion target. Sora shut down. The Disney partnership ended. The Walmart pilot shuttered.

xAI lost \$2.47 billion on \$818 million of Q1 revenue, burning approximately \$1 billion a month. Grok did not appear in the top-25 App Store downloads.

Anthropic, by contrast, hit a \$30 billion annualised revenue run rate by April — 80× Q1 growth against a 10× target. Claude Code alone crossed \$1 billion ARR, on track to print \$11 billion of Q2 revenue at approximately \$600 million of operating profit.
...
Within coding, the adoption curve is approaching its top. Multiple late-2025 surveys, Stack Overflow, JetBrains, and GitHub's Octoverse, put professional-developer adoption of AI tools above 70%.<sup><a href="#ref-19">[19]</a></sup> The one vertical whose distribution layer exists is approaching saturation in new-user conversion. Further growth comes from deepening usage among existing users, not converting new ones — a slower, harder curve.
...
<DataInsight
  insight="A GPU delayed by two years has crossed an architectural boundary."
  context="A bridge delayed by two years is still a bridge."
/>

The depreciation clock has three hands.

**The first is the architecture cadence.** Two-year cycles, each generation delivering multiples of performance per watt on the frontier workloads the labs care about.
...
**The third is the power contract.** A 100 MW interconnection slot built in 2027 will not be filled with the GPUs ordered for it in 2024 if the GPUs ordered in 2026 do much more work per watt on the workloads that pay for them. The interconnection is the scarce asset. The chip is fungible. The slot will accept the highest-performing tenant.

These three hands rotate together. And yet the chip does not stop being useful when it stops being frontier.
...
And the same AI boom that paid for the order book is bidding up HBM, advanced packaging, substrate capacity, rack-scale integration, power delivery, and supplier margin across the silicon stack. Epoch AI's component teardown places B200 module production cost at roughly \$5,700–7,300, with HBM and advanced packaging together accounting for approximately two-thirds of variable unit cost.<sup><a href="#ref-26">[26]</a></sup> SemiAnalysis estimates memory could rise to roughly 30% of hyperscaler AI data-centre capex in 2026, up from approximately 8% in 2023–2024, with HBM undersupplied through 2027.<sup><a href="#ref-27">[27]</a></sup> Memory producers — Samsung, SK Hynix, Micron — have diverted capacity toward HBM and high-margin enterprise DRAM, constraining the broader DRAM market and feeding the consumer-GPU price inflation observable on retail shelves. The boom is inflating the cost of building new silicon at exactly the moment the per-transistor cost gain has weakened.

The wedge therefore widens from both ends. The plateau gets cheaper as the frontier evicts it. The frontier gets more expensive because the boom has bid up the inputs that make it. Software compounding then lifts useful work per dollar on the plateau chip in the middle, every year. For a workhorse workload — inference, embedding, fine-tuning, batch processing, retrieval, ranking, simulation, scientific computing — the relevant question is no longer which chip is newest. It is which system delivers the lowest cost per useful operation at acceptable latency, reliability, and compatibility, and on most economic work the plateau chip wins that contest by a wider margin every year.
...
The bottleneck was never the backbone. The backbone was finished by 2001. The bottleneck was *distribution* — the last copper mile between the optical trunk and the household, the dial-up modem at kilobit speeds, the DSL upgrade at megabit speeds, then cable DOCSIS, fibre-to-the-curb, fibre-to-the-home, 3G, 4G, 5G.

Bandwidth at the trunk was abundant from the day the fibre was lit. Bandwidth at the wall socket arrived a generation later, in layers, against the slow economics of digging up streets, upgrading consumer-premises equipment, and convincing households to pay for something they had not previously known they wanted. The optical fibre did its job in eighteen months. The distribution layer took two decades.
...
In AI, the distribution layer is reliability engineering, software guardrails, verification, observability, permissions, audit, and rollback; ringfencing, agentic harnesses, model distillation, quantisation, and the long tail of optimisations that make smaller models perform like larger ones on commodity hardware; integration into industry-specific software stacks, regulatory regimes, legal acceptance, procurement, insurance, liability, and workflow ownership. A frontier training run produces an input. Turning that input into intelligence the economy can apply is the distribution problem.
...
The compute flows down the slot hierarchy through several channels at once. The dominant and quietest is the **hyperscaler-internal cascade**: chips bought for frontier training drop to internal inference, then to ad ranking, then to batch work. The same silicon quietly serves different economics inside the same firm, year by year. This is invisible from outside. It shows up only as falling unit prices in cost-per-token guidance and steadily cheaper hyperscaler inference SKUs.

The redistribution does not always wait for the bust, or for the second tier of buyers. In May 2026, Anthropic took over the entire ~300 MW capacity of Colossus 1 — the Memphis facility built around 220,000+ Nvidia processors — under a SpaceX S-1 disclosed agreement at \$1.25 billion per month through May 2029, with reduced fees during the initial ramp and a 90-day termination right for either party.<sup><a href="#ref-20">[20]</a></sup> xAI itself shifted internal frontier training to Colossus 2 in Southaven, Mississippi, deploying next-generation GB200 Blackwell. The arrangement is the migration mechanism running on premium current-generation silicon: even fully energised frontier hardware reallocates as soon as another tenant can put it to higher-value use. The cascade starts at the top.

The reverse beat is already visible. The planned expansion of the Oracle/OpenAI Stargate campus in Abilene from 1.2 GW to 2.0 GW — an additional 600–800 MW of premium permitted slot — collapsed in early 2026 against a mix of financing complexity, OpenAI's revised demand forecasts, and operational problems including a winter weather event that took the liquid-cooling loop offline for several days. Microsoft took over the adjacent expansion, partnering with Crusoe to build two new buildings and an on-site 900 MW gas plant alongside Oracle's existing 350 MW backup. Even a fully designed, partly built premium slot can be reassigned when the original buyer's deployment economics no longer pencil out.<sup><a href="#ref-21">[21]</a></sup>
...
Inside the plateau tier itself, hyperscaler public cloud is the premium access layer. The spread of up to 10× between hyperscaler on-demand H100 SKUs and specialist clouds delivering the same hardware (Appendix J) is not a depreciation curve. It is a slot-rent curve. The chip is identical. The premium is for trust, energised slot, procurement, immediate availability, and enterprise support.

That premium is durable for one class of customer and a tax for another. The boom phase had one scarce unit: access to any serious GPU capacity. Hyperscalers dominated it. The deployment phase has a different scarce unit: verified intelligence inside a workflow at acceptable cost. That unit lives on the economic substrate — wherever regional cloud, sovereign cluster, second-tier colocation, enterprise rack, or industrial site provides verified compute at the lowest fully-burdened cost.
...
Modern Stockfish-class engines now outperform the original AlphaZero-style benchmark systems. A small NNUE evaluation network wrapped in engineered scaffolding, running blazing-fast on commodity CPUs, beats a much larger pure-neural approach from the previous paradigm — a system that required substantial GPU compute to play at all. The bounded engineered system outperforms the raw neural network. That is the shape of plateau intelligence.
...
The same arc — imitation learning, then reinforcement learning, then engineered environments — has now played out three times in three different domains.
...
A formal game, open-world robotics, general language and reasoning — three domains, one shape: learned components inside engineered scaffolding, outperforming the unbounded learned system on production tasks. The Stockfish architecture is what deployable AI already looks like.
...
That gap becomes structural across a deployment cycle.
...
Frontier intelligence is scarce. Frontier silicon — HBM, advanced packaging, networking, premium energised sites — is scarce. Civilisational intelligence is not permanently scarce. Nor is plateau silicon two cycles back, or the algorithms that run on it.
...
The figures are not comparable line items (capex, debt issuance, venture funding, and private-equity deployment are different cash flows), but together they describe the scale and structural mutation of finance directed at the AI infrastructure stack across distinct capital pools. The bond-issuance line in particular signals a regime change: historically self-funding technology platforms have shifted to external debt markets as organic free cash flow has compressed under the weight of physical buildout. Amazon's trailing-twelve-month free cash flow fell roughly 95% to \$1.2 billion in the same window in which it issued \$54 billion in bonds, split across a \$37 billion USD tranche (11 maturities, 2–50 years) and a record €14.5 billion Euro tranche (8 maturities, 2–38 years, peak demand exceeding €35 billion). The pattern is broad: Meta issued \$30 billion in October 2025; Alphabet issued \$32 billion in February 2026 including a rare 100-year bond; Oracle planned \$25 billion for 2026 against an upward-revised \$50 billion FY2026 capex guide; Microsoft's pipeline remains active. The top-five aggregate matches the \$121 billion 2025 total and tracks toward the BofA-projected \$175 billion for 2026.
...
The Cast AI 2026 State of Kubernetes Optimization Report makes the broader pattern explicit. Across surveyed production clusters: 8% average sustained CPU utilisation, 20% average memory utilisation, 69% CPU overprovisioning headroom, 79% memory overprovisioning headroom, and fewer than 2% of GPU workloads running on spot instances through most of 2025 — primarily because spot capacity was effectively unavailable at hyperscaler scale. Engineering teams overprovisioned to avoid out-of-memory evictions and throttling, locking up paid capacity against intermittent demand. The cluster ceilings tell a related story: specialised clusters using GPU time-slicing and Nvidia Multi-Instance GPU partitioning sustain up to 49% GPU utilisation, suggesting that the binding constraint is workflow design and scheduling primitives, not chip capability.
...
**H.8 — Boom-driven input-cost inflation.** H.7 established that the frontier increasingly compounds through capital intensity and packaging innovation rather than transistor scaling. The cost-side corollary is that the binding inputs to new-generation silicon — HBM, advanced packaging, substrate capacity, rack-scale integration, networking, power delivery, and supplier margin — are now in tight supply against the same demand curve driving the order book. The $p_F \approx 1.05$/yr launch-price drift used in the identity above is not a noise term. It is the cost-side channel through which the boom widens the plateau wedge.

Epoch AI's component teardown places B200 module production cost at roughly \$5,700–7,300, with HBM and advanced packaging together accounting for approximately two-thirds of variable unit cost.<sup><a href="#ref-26">[26]</a></sup> SemiAnalysis estimates memory could rise to roughly 30% of hyperscaler AI data-centre capex in 2026, up from approximately 8% in 2023–2024, with HBM undersupplied through 2027.<sup><a href="#ref-27">[27]</a></sup> The major memory producers — Samsung, SK Hynix, Micron — have diverted general-purpose DRAM capacity toward HBM and high-margin enterprise DRAM through the same window, constraining the broader DRAM market and feeding consumer-GPU price inflation as a second-order effect. The structural reading is that the boom is bidding up the inputs to new silicon at exactly the moment the per-transistor cost gain has weakened. $p_F$ is a structural variable, not exogenous drift.

The implication for the threshold $\delta^*(p_F) = (g_q - p_F)/g_q$ is direct. Every additional point of $p_F$ relaxes the threshold by approximately one point of $\delta$. If boom-driven inflation pushes $p_F$ from 1.05 to 1.08 over the next two generations — a plausible trajectory given current memory and packaging supply dynamics — the threshold on FLOPS/W (currently failing at 0.29 against observed $\delta = 0.25$) drops to ~0.26, on the cusp of firing. The wedge does not need the frontier to slow further. It only needs the frontier to keep getting more expensive at the same rate the boom is producing.

**The cycle modulates; the cascade persists.** The cost-side channel is cyclical, not structural — but the post-bust generation arrives later than naive cyclical reasoning suggests, because the production pipeline is committed years in advance. Hyperscaler order books already span Rubin and Rubin Ultra into 2027–2028 and Feynman into 2028–2029, with substantial allocation booked; if the boom continues another year, the generation after Feynman gets pre-ordered as well. Production cadence is locked. What the bust changes is the *clearing price* of that pipeline as it lands, not the schedule — committed chips arrive on the published cadence and their secondary-market pricing collapses to plateau levels on a shorter clock than in prior cycles. The genuinely new-design generation — the one whose orders get placed *after* the bust crystallises — is materially further out than 12–18 months because the existing pre-order pipeline absorbs production capacity through 2029–2030. But the slot mechanism described in §V handles pre-ordered and new-design generations identically. Each reserves frontier slots first, ramps over multiple years rather than landing instantly, and displaces the prior generation into the same plateau cascade the framework predicts. The boom pulses the cost-side channel up; the bust pulses it down on the chips it touches; the slot hierarchy continues underneath. The plateau migration is a structural feature, accelerated by busts but not contingent on them.
...
**Hyperscaler depreciation extensions.** Microsoft (2022), Alphabet (2023), Meta (2023), Oracle (2024), and Amazon (2024) have each extended useful-life assumptions for server infrastructure from approximately four years to six years, with several signalling intent to extend further. These are not marketing claims. They are CFO-signed statements with personal Sarbanes-Oxley liability, audited by the Big 4, and defended against internal utilisation and revenue-attribution data no outside analyst sees. Each extension is an audit-level acknowledgment that the chips remain operationally useful far longer than the original capex cycle anticipated — precisely the gap between *frontier obsolescence* (~2 years) and *capability obsolescence* (~5–10+ years) the three-regime table predicts. Microsoft's FY2023 extension alone added approximately \$3.7 billion to annual operating income; the aggregate impact across the top five hyperscalers is on the order of \$15 billion per year in reduced depreciation expense. The same CFOs are simultaneously issuing record bond volumes to fund new silicon and extending useful-life on the existing fleet. Both claims are individually defensible. Together they imply that the productive compute fleet is becoming both larger and longer-lived than the original capacity model assumed — which is the migration mechanism on the balance sheet, two to four years ahead of any visible secondary market.

**Falsification test on depreciation policy.** The cleanest forward signal against the plateau thesis would be a hyperscaler *shortening* AI-GPU depreciation in audited filings — Microsoft moving H100s from six to three or four years in an FY2027 10-K, for example, and the Big 4 signing off on the change against internal workload data. As of mid-2026, no major hyperscaler has done so. Late-2025 analyst commentary floated the idea; the filings have continued to extend, not contract. The audited curve and the keynote curve have not yet been reconciled in either direction. The keynote curve makes capability claims unaudited; the audited curve makes utility claims unmarketed. The thesis tracks the second.
...
**Multi-model routing volume as workload-share signal.** Independent confirmation of the workload migration is available at the API aggregation layer. OpenRouter — the multi-model routing platform serving 8M+ developers — disclosed aggregate token throughput growing from approximately 5 trillion to 25 trillion tokens per week over the six months ending May 2026, a 5× expansion in tokens routed across the heterogeneous plateau-tier model surface (Anthropic, OpenAI, Google, Meta, DeepSeek, and the open-weights ecosystem).<sup><a href="#ref-25">[25]</a></sup> The platform's \$113M Series B in May 2026 was led by Google's growth fund CapitalG with NVIDIA Ventures, Snowflake, Databricks, MongoDB, ServiceNow, Andreessen Horowitz, and Menlo Ventures participating — the enterprise-data and silicon stacks underwriting the multi-model topology rather than a winner-take-all frontier outcome. The data point confirms the *topology* the framework predicts: workload distributed across multiple plateau-tier providers, routed through aggregation infrastructure independent of any single lab. It does not by itself resolve the *durability* question raised in §II — a meaningful fraction of token throughput at this stage of the cycle tracks the same non-durable enterprise AI-budget allocation the framework expects the 2026–2027 procurement reset to normalise. The shape is confirmed; the absolute level is not yet underwritten.
...
At the workflow level, the downstream verification burden compounds the friction. The METR randomised controlled trial (2025) found experienced open-source developers were 19% *slower* using AI tools — the cognitive cost of reviewing non-deterministic AI output exceeded the speedup from generation.<sup><a href="#ref-31">[31]</a></sup> Google's DORA 2024 report associated a 25% increase in AI adoption with a 7.2% *decrease* in production delivery stability. Google Cloud (2026) reports 45% higher burnout among frequent AI users — approval fatigue, where the same engineer who used to write code at 1× now reviews AI-generated micro-updates at 3×, with predictable consequences for review quality and downstream system reliability. GitClear's analysis of 153 million changed code lines projected a doubling of code churn directly translating into delivery instability. The mechanism is replicated across multiple independent sources and is now properly described as the *Productivity-Reliability Paradox*: individual-level lab speedups of 20–56% on isolated tasks fail to translate into firm-level velocity because architectural integration and verification absorb the gains.
...
The discipline that produces the framework's predictive validity is that it remains publicly falsifiable. If any forward prediction falsifies in real time, the framework updates accordingly. The essay is not a narrative assembled to fit observed data; it is a mechanistic theory of compute access in the deployment-phase economy, exposed to the world's verdict on a forward verification track. The methodology is the methodology of any mechanistic theory: state the relationships precisely enough to be falsifiable, expose them to risky predictions, accumulate corroboration only by remaining willing to be wrong. The cascade described across this essay is what is predicted; whether it resolves on the timetable, in the magnitudes, and through the channels specified is what the next five years will demonstrate.
...
<span id="ref-11">[11]</span> Reuters / Crusoe Energy / Oracle (2026). "Abilene, Texas campus." 400,000 GB200-class chips ordered; 1.2 GW total facility design power across eight planned buildings, two operational as of mid-2026. Project capital approximately \$15 billion, including a \$9.6 billion JPMorgan-led loan. Operated under a fifteen-year Oracle master lease to OpenAI as the end tenant.
...
<span id="ref-18">[18]</span> The Information, Reuters, Morningstar, VentureBeat, AI Weekly, Bloomberg, and 24/7 Wall St (Q1–Q2 2026). **OpenAI Q1 2026:** revenue approximately \$5.7 billion against an operating loss of approximately \$6.95 billion (-122% non-GAAP operating margin), tracking toward an estimated \$36.6 billion loss on \$30 billion of projected 2026 revenue; ChatGPT weekly active users averaged 905 million in Q1, stalling below a 1 billion target. OpenAI subsequently shut down Sora, ended its \$1 billion Disney partnership, and shuttered the Walmart Instant Checkout pilot. **Anthropic April 2026:** annualised revenue run rate of \$30 billion (80× Q1 growth against CEO Dario Amodei's 10× target); Claude Code crossed \$1 billion ARR; Q2 2026 guidance targets more than \$11 billion of revenue at approximately \$600 million of operating profit. **xAI Q1 2026:** operating loss of \$2.47 billion on \$818 million of revenue (FY2025: \$6.36 billion loss on \$3.20 billion of revenue); approximately \$1 billion per month operational burn; Grok excluded from the top-25 App Store downloads, with SpaceX reportedly pressuring its IPO underwriting banks to purchase Grok subscriptions to secure roles in the offering.
...
<span id="ref-20">[20]</span> SpaceX S-1 filing (May 20, 2026), corroborated across Reuters, Business Insider, The Verge, Wall Street Journal, TechCrunch, Data Center Dynamics, Anthropic's own announcement, and subsequent reporting. Anthropic took over the entire ~300 MW capacity of Colossus 1 (Memphis, TN), housing 220,000+ Hopper-class Nvidia processors. The S-1 discloses payments of \$1.25 billion per month through May 2029, with reduced fees during the initial ramp (May–June 2026) and a 90-day termination right for either party. xAI shifted internal frontier training to Colossus 2 in Southaven, Mississippi, deploying next-generation GB200 Blackwell. Disclosed following the February 2026 merger of xAI into SpaceX (combined entity valued at \$1.25 trillion); SpaceX's S-1 targets raising \$75 billion at a \$2 trillion valuation, with shares trading from June 2026 led by 23 banks. Anthropic operates the Colossus arrangement alongside separate multi-gigawatt commit agreements with Google and Amazon, against the backdrop of Claude Code crossing \$1 billion ARR and Anthropic's broader \$30 billion annualised revenue run rate by April 2026.
...
<span id="ref-36">[36]</span> Brynjolfsson, E., Rock, D., and Syverson, C. (2021), "The Productivity J-Curve: How Intangibles Complement General Purpose Technologies," *American Economic Journal: Macroeconomics* (originally NBER Working Paper 25148, 2018). Formalises the structural lag between general-purpose technology arrival and aggregate productivity gains via the accumulation of unmeasured complementary intangible capital. Foundational reference for the absorption-phase argument in K.1. Companion references: Atlanta Federal Reserve / Richmond Federal Reserve / Duke University CFO Survey (March 2026), *How Might AI Change the Workplace?*, finding 80%+ of large enterprises actively investing in AI but realised revenue per employee projected to rise only 1.5% in 2026 — the empirical signature of the J-Curve in current data; Federal Reserve Bank of Atlanta Survey of Business Uncertainty (SBU) (2025–2026), employment-weighted firm-level AI adoption of 78% against Census Bureau Business Trends and Outlook Survey absolute firm-level adoption of 18%, illustrating the fragmented integration pattern; Carlota Perez (2002), *Technological Revolutions and Financial Capital* (Edward Elgar), the canonical installation-to-deployment framework discussed in K.4 (already cited under Background References).
