...
**380 MW block supersession — 17 July 2026.** The historical block-scale findings above are void as programme recommendations. The ~380 MW coherent block and P4 gate came from the earlier space-based architecture and are not required anywhere in the stratospheric programme. Current authority stops at the independently interlocked ~19 MW P3 rack; capacity above one rack scales through additional racks and corridors without cross-rack coherence. The models never depended on the retired block, so this correction changes gate narrative and publication evidence, not economics.
